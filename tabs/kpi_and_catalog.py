...
tab_kpi_catalog = dcc.Tab(
    label="KPIs & catalogue",
    children=[
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        dbc.Button(
                            id="kpi:button_refresh", children="Rafraîchir les données"
                        ),
                    ]
                ),
            ],
                ...
                dbc.Col(
                    [
                        dcc.Dropdown(
                            ...
                            value="all",
                            options=[
                                {"label": "Tous les jeux de données", "value": "all"},
                                {
                    ...
                    [
                        dcc.Dropdown(
                            ...
                            options=[
                                ...
                                {"label": "Ressources principales", "value": "main"},
                                {"label": "Documentations", "value": "documentation"},
                                {"label": "API", "value": "api"},
...
def refresh_kpis_dropdown(datastore):
    ...
    options = [{"label": k, "value": k} for k in kpis["indicateur"].unique()]
...
def change_datasets_quality_graph(indic, param):
    ...
    volumes = [
        [first_day_same_month(d), datasets_quality[d]["count"][indic]]
